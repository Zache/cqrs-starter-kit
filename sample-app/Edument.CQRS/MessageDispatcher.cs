...
using Edument.CQRS.Annotations;
...
namespace Edument.CQRS
{
	...
	public class MessageDispatcher
	{
		...
		[UsedImplicitly]
		public void ReplayEvents<TAggregate>(Guid aggregateId)
		{
			var events = eventStore.LoadEventsFor<TAggregate>(aggregateId);
		...
		/// </summary>
		/// <typeparam name="TEvent">Type of the event the subscriber is interested in.</typeparam>
